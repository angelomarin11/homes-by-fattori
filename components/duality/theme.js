...
export const S = {
  ...
  langBtn: { minWidth: 34, height: 30, padding: "0 8px", borderRadius: 8, border: `1px solid ${LINE}`, background: CARD, color: DIM, fontFamily: FM, fontSize: 11, fontWeight: 700, letterSpacing: 1, cursor: "pointer", opacity: .55, lineHeight: 1 },
  langOn: { opacity: 1, borderColor: "#fff5", color: INK },
