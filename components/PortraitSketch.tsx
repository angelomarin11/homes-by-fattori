...
/**
 * Pen-and-ink style house sketches used as elegant local placeholders for
 * portfolio artwork until real scans are supplied. Pure SVG — no network
 * requests, crisp at any size, themed with the brand palette.
 *
...
export default function PortraitSketch({
  ...
  return (
    ...
    >
      <rect width="600" height={height} fill="#F2EDE1" />
      <rect
        x="20"
        y="20"
        width="560"
